...
<head>
    ...
    <title>Permanent Voters Card Statistics</title>
              ...
              <form action="" method="post" novalidate="novalidate">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Permanent Voters Card</strong>
                        </div>
                        <div class="card-body">
                            <!-- <div class="card-title">
                                <h3 class="text-center"></h3>
                            </div> -->
                          <?php isset($results) ? display_errors($results) : '';  ?>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" name="type" required>
                                <option value="" selected disabled hidden>-- Please, select form type</option>
                          ...
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group">
                                  ...
                                  <input id="firstname" name="firstname" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="First Name" required>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group">
                                  <label for="lastname" class="control-label mb-1">Last Name</label>
                                  <input id="lastname" name="lastname" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Last Name" required>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group">
                                  ...
                                  <input id="phoneno" name="phoneno" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Phone Number" required>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input id="email" name="email" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Email Address" required>
                          </div>
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group">
                                  <label for="gender" class="control-label mb-1">Gender</label>
                                  <select id="gender" name="gender" class="form-control" aria-required="true" aria-invalid="false" required>
                            ...
                            <div class="col-lg-6">
                              <div class="form-group">
                                  ...
                                  <select class="form-control" id="occupation" name="occupation" required>
                                    <option value="" selected hidden disabled>-- Select Occupation </option>
                            ...
                            <div class="col-lg-6">
                              <div class="form-group">
                                  ...
                                  <select class="form-control" name="lga" id="lga" required>
                                    <option value="" selected hidden disabled>-- Select Local Govt. Area </option>
                                  </select>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" name="ward" id="ward" required>
                                <option value="" selected hidden disabled>-- Select Ward </option>
                              </select>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" name="pul" id="pul" required>
                                <option value="" selected hidden disabled>-- Select Polling Unit Location </option>
                              </select>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" name="observer" id="observer" required>
                                <option value="" selected hidden disabled>-- Do you wish to become an Observer? </option>
                        ...
                        <div class="card-footer">
                          <div class="pull-right">
                            ...
                            <button id="submit-button" type="submit" name="submit-data" class="btn btn-outline-success ">
